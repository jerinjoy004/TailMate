      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-muted-foreground">
              A unified platform for animal welfare coordination and support.
            </p>
          </div>
          
          <div className="md:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div>
              <h4 className="text-sm font-semibold uppercase tracking-wide mb-4">Platform</h4>
              <ul className="space-y-3">
                {['Features', 'How It Works', 'User Roles', 'Pricing', 'FAQ'].map((item, i) => (
                  <li key={i}>
                    <a 
                      href="#" 
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            &copy; {new Date().getFullYear()} Tailmate. All rights reserved.
          </p>
