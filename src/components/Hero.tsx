      ...
      <div className="container relative px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <AnimatedSection delay={100}>
            <span className="inline-block px-2.5 py-1 mb-4 md:mb-6 text-xs md:text-sm font-medium text-primary bg-primary/10 rounded-full">
          ...
          <AnimatedSection delay={500}>
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 md:mb-8 max-w-2xl mx-auto">
              A unified platform for reporting, funding, and coordinating animal
              welfare efforts in your community.
            </p>
          </AnimatedSection>
        ...
        >
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-tailmate-400/20 to-tailmate-700/20 flex items-center justify-center text-white">
              <div className="p-10 text-center">
                <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-white/10 flex items-center justify-center">
                  ...
                  >
                    <path
                      d="M12 8C8.13 8 5 11.13 5 15V19H19V15C19 11.13 15.87 8 12 8Z"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
                    ...
                    />
                    <path
                      d="M17 6C17 7.65685 14.7614 9 12 9C9.23858 9 7 7.65685 7 6C7 4.34315 9.23858 3 12 3C14.7614 3 17 4.34315 17 6Z"
                      stroke="currentColor"
                      strokeWidth="2"
                    />
                  </svg>
          ...
          <div className="absolute -right-4 -bottom-4 w-32 h-32 bg-white rounded-xl shadow-soft border border-border/50 flex items-center justify-center p-4 rotate-3">
            ...
            >
              ...
              />
              <path
                d="M10 8L9.75 4.5C9.69782 3.95992 9.43524 3.4647 9.01825 3.11586C8.60127 2.76703 8.06542 2.59422 7.52 2.635C6.97632 2.6768 6.47068 2.91076 6.10122 3.29348C5.73177 3.67621 5.5294 4.1833 5.53 4.71"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M14 8L14.25 4.5C14.3022 3.95992 14.5648 3.4647 14.9818 3.11586C15.3987 2.76703 15.9346 2.59422 16.48 2.635C17.0237 2.6768 17.5293 2.91076 17.8988 3.29348C18.2682 3.67621 18.4706 4.1833 18.47 4.71"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M10 16L9.5 19.5C9.44782 20.0401 9.18524 20.5353 8.76825 20.8841C8.35127 21.233 7.81542 21.4058 7.27 21.365C6.72632 21.3232 6.22068 21.0892 5.85122 20.7065C5.48177 20.3238 5.2794 19.8167 5.28 19.29"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M14 16L14.5 19.5C14.5522 20.0401 14.8148 20.5353 15.2318 20.8841C15.6487 21.233 16.1846 21.4058 16.73 21.365C17.2737 21.3232 17.7793 21.0892 18.1488 20.7065C18.5182 20.3238 18.7206 19.8167 18.72 19.29"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
